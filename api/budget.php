...
<?php
	 ...
	 * @param abeAjax $ajax Ajax object for returning data or reporting an error.
	 */
	private function SuggestAverageMonth(mysqli $db, abeAjax $ajax) {
	 ...
	 */
	private function SuggestSpecificMonths(mysqli $db, abeAjax $ajax, string $month) {
	 ...
	 */
	private function SuggestOneMonth(abeAjax $ajax, mysqli_stmt $stmt, int $y, int $m) {
